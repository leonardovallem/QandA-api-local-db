...
//
//import com.vallem.Perguntas.API.entity.Pergunta;
//import com.vallem.Perguntas.API.entity.Usuario;
//import com.vallem.Perguntas.API.index.BPlusTree;
//
...
//        this.usuariosDao = new DAO<>(Usuario.class.getConstructor(), "usuarios.db");
//        this.perguntasDao = new DAO<>(Pergunta.class.getConstructor(), "perguntas.db");
//        this.perguntasStorage = new BPlusTree(5, "perguntas.tree.db");
//    }
//
//    /**
...
//        DAO<Usuario> userDAO = new DAO<>(Usuario.class.getConstructor(), "usurios.db");
//
