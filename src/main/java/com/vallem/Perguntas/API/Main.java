...
//
//import com.vallem.Perguntas.API.entity.KeyValuePairs.UsuarioKeyValuePair;
...
//
//        dao = new DAO<>(Usuario.class.getConstructor(), "usuarios.db");
//        he2 = new HashExtensivel<>(UsuarioKeyValuePair.class.getConstructor(), 4,
//                dao.file.replace(".db", ".mail_d.db"),
//                dao.file.replace(".db", ".mail_c.db"));
//
