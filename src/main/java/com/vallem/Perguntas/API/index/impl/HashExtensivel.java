...
v1.1 - 2021
*/
package com.vallem.Perguntas.API.index.impl;

import com.vallem.Perguntas.API.index.RegistroHashExtensivel;
...
public class HashExtensivel<T extends RegistroHashExtensivel<T>> {
    ...
    public HashExtensivel(Constructor<T> ct, int n, String nd, String nc) throws Exception {
        ...
        // apaga os índices anteriores
        new File(nomeArquivoDiretorio);
        new File(nomeArquivoCestos);
